...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/item_class')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_item_class'),
					'href'     => $this->url->link('catalog/item_class', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'customer/user_list')) {
				$customer[] = array(
					'name'	   => $this->language->get('text_user_list'),
					'href'     => $this->url->link('customer/user_list', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
