...
class ControllerAccountOrder extends Controller {
	public function index() {
		...
		foreach ($results as $result) {
			...
			$data['orders'][] = array(
				...
				'gp_order_no' => $result['gp_order_no'],
	...
	public function info() {
		...
		if ($order_info) {
			...
			if (isset($order_info['gp_order_no']) && !empty($order_info['gp_order_no'])) {
				$data['gp_order_no'] = $order_info['gp_order_no'];
			} else {
				$data['gp_order_no'] = '';
			}
			//var_dump($order_info['gp_order_no']);
